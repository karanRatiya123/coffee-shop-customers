...
(function () {
    ...
    if (!isLoggedIn) {
        ...
        const returnTo = window.location.pathname.split('/').pop() || 'home.html';
        ...
        ctaSlot.outerHTML = `
            <div class="user-menu" id="user-menu">
                ...
                <div class="user-menu-dropdown" id="user-menu-dropdown" role="menu">
                    ...
                    <a href="order.html" class="user-menu-item" role="menuitem">
                    ...
                    <a href="home.html#featured" class="user-menu-item" role="menuitem">
